<?php /* Smarty version Smarty-3.1.19, created on 2017-02-21 10:37:00
         compiled from "/home/anicet_j/Rendu/presta/prestashop/themes/samsung_campus/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:192533486058ac0a3c9df5d7-82006899%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7d7b9861876653769c8821878cae233e22a3a74' => 
    array (
      0 => '/home/anicet_j/Rendu/presta/prestashop/themes/samsung_campus/header.tpl',
      1 => 1487568098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '192533486058ac0a3c9df5d7-82006899',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58ac0a3cae3c83_33971025',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58ac0a3cae3c83_33971025')) {function content_58ac0a3cae3c83_33971025($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home/anicet_j/Rendu/presta/prestashop/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
<!-- Scroll Header Freeze - Start -->
<script type="text/javascript">
    jQuery(function() {
        jQuery(window).scroll(function() {
            if (jQuery(".container").width()>767){
                if (jQuery(this).scrollTop() > jQuery ('#page .header-container').height()) {
                    jQuery('#spy').removeClass('unvisible');
					jQuery('#spy').addClass('fix');
					jQuery('#spy #spylogo').html(jQuery('#header_logo:first').clone());
					jQuery('#spy #spymenu').html(jQuery('#block_top_menu:first').clone(true));
					jQuery('#spy #spysearch').html(jQuery('#search_block_top:first').clone(false));	
					
					
                } else {
                    jQuery('#spy').removeClass('fix');
					jQuery('#spy').addClass('unvisible');
                }}
        });
...
<div class="" id="spy">
	<div class="container">
		<div id="spylogo"></div>
		<div id="spymenu"></div>
		<div id="spysearch"></div>
		<div id="spycartbtn">
			<a href=""></a>
			</div>
		<div id="spycart">
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart'),$_smarty_tpl);?>
" rel="nofollow">
...
<?php echo smartyTranslate(array('s'=>' product'),$_smarty_tpl);?>
				...
				<span class="ajax_cart_no_product" <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value!=0) {?>style="display:none"<?php }?>><?php echo smartyTranslate(array('s'=>'(empty)'),$_smarty_tpl);?>
</span>
