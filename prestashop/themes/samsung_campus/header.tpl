...
<div class="" id="spy">
	<div class="container">
		...
		<div id="spycart">
			<a href="{$link->getPageLink('order')|escape:'html'}" title="{l s='View my shopping cart'}" rel="nofollow">
				<span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}">{$cart_qties}{l s=' product'}</span>
